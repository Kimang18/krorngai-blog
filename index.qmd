...
- TrorYongOCR: Optical Character Recognition Models with my design of model architecture (`pip install tror-yong-ocr` or more info [here](https://pypi.org/project/tror-yong-ocr/)) 
